...
public class Sub5DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub5_details);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_view_Sub5Details);
        ...
        pb = findViewById(R.id.pro_Sub5Details);
        mRecyclerView = findViewById(R.id.recyclerView_Sub5Details);
        mRecyclerView.setHasFixedSize(true);

        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));

        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mRef = mFirebaseDatabase.getReference("Sub5Details");
