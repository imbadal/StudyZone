...
public class Sub3DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub3_details);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_view_Sub3Details);
        ...
        pb = findViewById(R.id.pro_Sub3Details);
        mRecyclerView = findViewById(R.id.recyclerView_Sub3Details);
        mRecyclerView.setHasFixedSize(true);

        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));

        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mRef = mFirebaseDatabase.getReference("Sub3Details");
