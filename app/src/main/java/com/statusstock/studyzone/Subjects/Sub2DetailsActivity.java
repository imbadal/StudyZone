...
public class Sub2DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub2_details);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_view_Sub2Details);
        ...
        pb = findViewById(R.id.pro_Sub2Details);
        mRecyclerView = findViewById(R.id.recyclerView_Sub2Details);
        mRecyclerView.setHasFixedSize(true);

        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));

        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mRef = mFirebaseDatabase.getReference("Sub2Details");
